...
```{bash,eval=FALSE}
# Download the phenotype description file
dest = "20130606_g1k.ped"
src = sprintf("ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/technical/working/20130606_sample_info/%s", dest)
download.file(src, dest=dest)
