...
**NOTE I'm still experimenting with the best partition sizes for my small RAM
PC. I notice that I'm using swap in these tests, which is not good. Stay tuned.**
...
t1 = proc.time()
L  = irlba(A, nv=3, right_only=TRUE, verbose=TRUE)
dt = proc.time() - t1
```
...
** NOTE I'm still working on this, I think I got the chunks too big...hitting swap. **
