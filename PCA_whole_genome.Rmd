...
library(threejs)
scatterplot3js(L$v, size=0.5)
```

Compare these clusters with those obtained from one chromosome here
http://bwlewis.github.io/1000_genomes_examples/PCA.html. As shown in that
example, the clusters correspond to superpopulations. Notice however that there
is a but more detail in the whole genome plot. Zooming in on some of the
