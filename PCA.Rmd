...
_NOTE!_ The development version if `irlba` is required for this example for now.
I expect that the CRAN version will be updated in October, 2015. Please install it with the `devtools` package:
```
