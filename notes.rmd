...
The first version is designed for large SMP computers such that the whole
...
The second version is designed for distributed computers, and for computers
...
the data file `meta.rdata` for re-use.
